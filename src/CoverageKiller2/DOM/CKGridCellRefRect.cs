...
namespace CoverageKiller2.DOM
{
    ...
    /// Cell References are for TableGrid-based coordinates.
    /// </summary>
    public class CKGridCellRefRect : ICellRef
    {
        /// <summary>
        ...
        public string Mode => nameof(CKGridCellRefRect);
        ...
        /// </summary>
        private CKGridCellRefRect(int x1, int y1, int x2, int y2)
        {
            if (x1 < 1 || y1 < 1)
        ...
        public static CKGridCellRefRect ForCell(int x, int y)
        {
            return new CKGridCellRefRect(x, y, x, y);
        }
        ...
        public static CKGridCellRefRect ForRow(int rowIndex, int columnCount)
        {
            if (rowIndex < 1)
            ...
            return new CKGridCellRefRect(1, rowIndex, columnCount, rowIndex);
        }
        ...
        public static CKGridCellRefRect ForColumn(int columnIndex, int rowCount)
        {
            if (columnIndex < 1)
            ...
            return new CKGridCellRefRect(columnIndex, 1, columnIndex, rowCount);
        }
        ...
        public static CKGridCellRefRect ForRectangle(int x1, int y1, int x2, int y2)
        {
            return new CKGridCellRefRect(x1, y1, x2, y2);
        }
